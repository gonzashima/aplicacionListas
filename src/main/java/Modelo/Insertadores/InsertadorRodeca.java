...
public class InsertadorRodeca extends Insertador{
    ...
    public void insertarABaseDeDatos(HashMap<Integer, HashMap<Integer, Producto>> datos) throws SQLException {
        ...
        int codigo = ConstantesNumericas.codigoLista(ConstantesStrings.RODECA);
        ...
        datos.replace(codigo, ConectorDB.seleccionarProductos(ConstantesStrings.RODECA));
    }
}
